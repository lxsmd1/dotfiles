...
" ================ Package Manager ====================
" Loads all files from .vim/bundle

execute pathogen#infect()

" ctrlp                         Fuzzy search
" NERDTree                      Visual tree support
" SuperTab                      Tab completions
" vim-endwise                   Adds completing 'end' to method calls
" lightline                     Visual bottom status bar

" ================ General Config ====================

set relativenumber number       "Line numbers are good [`relativenumber`, `number`]
...
" (just a list of correctly-spelled words, not a list of magical incantations)
